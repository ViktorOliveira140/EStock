<form action="../database/item/outbound.php" method="post">
<input type="hidden" name="id" value="<?php echo $id ?>">
    ...
    <div class="field">
        <label class="label">Quantidade a Retirar</label>
        <div class="control">
            <input class="input" type="number" name="quantidade_retirada" placeholder="Informe a quantidade a retirar" required>
        </div>
    </div>
